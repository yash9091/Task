...
function App() {
  ...
  return (
    <>
      <Navbar className="bg-white border-gray-200 dark:bg-gray-900 w-screen">
        <div className="max-w-screen-xl flex flex-wrap justify-between gap-20 mx-auto  p-8">
          ...
          <div className="  flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
            <Button
              type="button"
              className="flex text-sm object-contain md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
              id="user-menu-button"
            ...
            {/* <!-- Dropdown menu --> */}
            <div
  className={`z-10 ${isDropdownOpen ? 'absolute' : 'hidden'} top-12 right-0 mt-2 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
  id="user-dropdown"
>
